...
def compute_cirr_results_test(caption: str, cirr_test_index_features, clip_model, combiner: Combiner, n_retrieved: int, reference_name: str) -> Tuple[
    Union[list, object], np.array, str]:
    """
    Combine visual-text features and compute CIRR results
    :param caption: relative caption
...
def compute_cirr_results_test_relative(captions: list, cirr_test_index_features, clip_model, combiner: Combiner, n_retrieved: int, reference_name: str) -> Tuple[
    Union[list, object], np.array, str]:
    """
    Combine visual-text features and compute CIRR results
    :param caption: relative caption
    ...
    with torch.no_grad():
        predicted_features = reference_features
        for cap in captions:
